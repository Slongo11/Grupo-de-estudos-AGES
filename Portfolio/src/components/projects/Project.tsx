...
const Project = () => {
    const projects = [
        {title: "AGES Study Group Repository", src: "./AGESPNB.png", href: "https://github.com/Slongo11/Grupo-de-estudos-AGES", alt: "Repository AGES", comment: "This repository documents the full journey within the AGES program, featuring 5 sprints and 5 distinct projects, each progressively more challenging and complex."},
